export const StatsPieChart: any[] = [
    ...
    { id: 6, party: '山本',electionP:6,goal:10},
    { id: 7, party: '中村',electionP:5,goal:10},
    { id: 8, party: '小林',electionP:3,goal:5},
    { id: 9, party: '加藤',electionP:2,goal:5},
    { id: 10, party: '中村',electionP:1,goal:5}
];